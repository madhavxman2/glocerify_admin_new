...
import delivery from "../assets/images/facewash.svg"
const DeliveredTableSeller = () => {
  return (
    <div className="flex flex-col space-y-4">
            ...
            <div className="flex flex-row justify-between text-[#333333] text-[14px] h-[82px] shadow-md pt-4 pb-2 pl-4">
                <div className="w-2/6 font-Gorditas flex flex-row"><img src={delivery} alt='delivery' />Innis free Face wash  25 gm</div>
...
export default DeliveredTableSeller